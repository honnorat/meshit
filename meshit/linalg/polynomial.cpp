...
namespace meshit {
    ...
    QuadraticPolynomial1V::QuadraticPolynomial1V(double ac, double acx, double acxx)
    {
        c = ac;
        cx = acx;
        cxx = acxx;
    ...
    double QuadraticPolynomial1V::Value(double x)
    {
    ...
    LinearPolynomial2V::LinearPolynomial2V(double ac, double acx, double acy)
    {
        c = ac;
        cx = acx;
        cy = acy;
    ...
    QuadraticPolynomial2V::QuadraticPolynomial2V(
            double ac, double acx, double acy,
    ...
    void QuadraticPolynomial2V::Square(const LinearPolynomial2V & lp)
    {
        c = lp.c * lp.c;
        cx = 2 * lp.c * lp.cx;
        cy = 2 * lp.c * lp.cy;
    ...
    void QuadraticPolynomial2V::Add(double lam, const QuadraticPolynomial2V & qp2)
    {
        c += lam * qp2.c;
        cx += lam * qp2.cx;
        cy += lam * qp2.cy;
    ...
    double QuadraticPolynomial2V::Value(double x, double y)
    {
        return c + cx * x + cy * y + cxx * x * x + cxy * x * y + cyy * y * y;
    }

    double QuadraticPolynomial2V::MaxUnitSquare()
    {
        // find critical point
    ...
    double QuadraticPolynomial2V::MaxUnitTriangle()
    {
        // find critical point
