...
namespace meshit {
    ...
    class MinFunction_2d
    {
     ...
     public:
        ...
        // function + gradient
        double FuncGrad(const double* x, double* g) const;

        // directional derivative
        double FuncDeriv(const double* x, const double* dir, double& deriv) const;
    };
     ...
     */
    double BFGS_2d(double* x, const MinFunction_2d& fun,
    ...
    int lines(
            ...
            const MinFunction_2d& fun,  // function to minmize
