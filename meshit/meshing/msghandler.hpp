...
#define LOG_FATAL_CONT(logEvent)     LOG_MACRO_BODY (logEvent, FATAL_LOG_LEVEL, false)
#define LOG_ERROR_CONT(logEvent)     LOG_MACRO_BODY (logEvent, ERROR_LOG_LEVEL, false)
#define LOG_WARNING_CONT(logEvent)   LOG_MACRO_BODY (logEvent, WARN_LOG_LEVEL, false)
